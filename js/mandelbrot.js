...
(function() {
  ...
  window.require(["jquery", "libs/modernizr-2.5.3-respond-1.1.0.min", "script", "libs/knockout-2.1.0", "mylibs/mandelbrot-core", "mylibs/color-converter", "mylibs/mandelbrot-colors"], function($, modern, script, ko, mandelCoreClass, cConverterClass, mandelColorsClass) {
